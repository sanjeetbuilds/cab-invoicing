 ...
 * page. The SamplePreview wrapper handles the natural opacity and
 * downward fade; these renderers just produce realistic-looking
 * cab-business rows (real client names, real amounts, real status
 * colours) so the user gets a true preview of how the populated
 * page will look. Each row carries a "SAMPLE" pill on the right so
 * the placeholder cue is visible without changing the row's data
 * styling.
 */
    ...
    <div className="flex flex-col gap-2">
      ...
      <Row>
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground">20/5/26, Outstation, 410 km</p>
        </div>
        <p className="font-mono text-sm font-semibold tabular-nums shrink-0">
          ₹9,020
        </p>
      ...
      <Row>
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground">24/5/26, Local, 78 km, night</p>
        </div>
        <p className="font-mono text-sm font-semibold tabular-nums shrink-0">
          ₹1,800
        </p>
  ...
  return (
    <div className="flex flex-col gap-2">
      <Row>
        ...
        <p className="font-mono text-sm font-semibold tabular-nums">₹68,250</p>
      ...
      <Row>
        ...
        <p className="font-mono text-sm font-semibold tabular-nums">₹42,500</p>
      ...
      <Row>
        ...
        <p className="font-mono text-sm font-semibold tabular-nums">₹23,890</p>
        <Badge variant="success">Paid</Badge>
        <SampleTag />
      </Row>
      <Row>
        ...
        <p className="font-mono text-sm font-semibold tabular-nums">₹37,420</p>
        <Badge variant="warning">Unpaid</Badge>
        <SampleTag />
      </Row>
      <Row>
        ...
        <p className="font-mono text-sm font-semibold tabular-nums">₹51,200</p>
        <Badge variant="success">Paid</Badge>
        <SampleTag />
      </Row>
      <Row>
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground">Greentech BPO, March 2026</p>
        </div>
        <p className="font-mono text-sm font-semibold tabular-nums">₹19,750</p>
        <Badge variant="success">Paid</Badge>
        <SampleTag />
      </Row>
      <Row>
        ...
        <p className="font-mono text-sm font-semibold tabular-nums">₹28,150</p>
        <Badge variant="success">Paid</Badge>
        <SampleTag />
      </Row>
    </div>
    ...
    <div className="flex flex-col gap-2">
      ...
      <Row>
        <div className="flex-1 min-w-0">
          ...
          <p className="text-xs text-muted-foreground">Apex Pharma, dated 22/5/26</p>
        </div>
        <Badge variant="accent">Sent</Badge>
        <SampleTag />
      </Row>
